    ...
    value: function buildTableHeader(data) {
      ...
      return data && data.length ? _react2.default.createElement(
        ...
        data.map(function (row, i) {
          return _this4.buildTableHeaderRow(row, i);
        })
      ) : null;
    }
  }, {
    ...
    value: function buildTableBody(data) {
      ...
      return _react2.default.createElement(
        ...
        { ref: function ref(_ref2) {
            return _this5.tbodyDom = _ref2;
          } },
        data.map(function (row, i) {
          return _this5.buildTableRow(row, i);
        })
      );
    }
  }, {
    key: 'buildTableHeaderRow',
    value: function buildTableHeaderRow(row, i) {
      var _this6 = this;
      ...
      return _react2.default.createElement(
        ...
        row.map(function (cell, j) {
          var props = {
            ...
            onWidthChange: function onWidthChange(newWidth) {
              return console.log(newWidth);
            }
          };
