  ...
  _createClass(DataSheet, [{
    ...
    value: function handleCopy(e) {
      if (isEmpty(this.state.editing)) {
        ...
        var _props = this.props,
            _dataRenderer = _props.dataRenderer,
            _valueRenderer = _props.valueRenderer,
            data = _props.data;
        ...
        var text = range(start.i, end.i).map(function (i) {
          return range(start.j, end.j).map(function (j) {
            var cell = data[i][j];
            var value = _dataRenderer ? _dataRenderer(cell, i, j) : null;
            if (value === '' || value === null || typeof value === 'undefined') {
              return _valueRenderer(cell, i, j);
            }
            return value;
          }).join('\t');
        }).join('\n');
    ...
    value: function buildTableHeader(data) {
      return data ? _react2.default.createElement(
        'thead',
        null,
        this.buildTableRow(data, 0, true)
      ) : null;
    }
  }, {
    key: 'buildTableBody',
    value: function buildTableBody(data, hasHeader) {
      var _this4 = this;

      var bodyIAdd = hasHeader ? 1 : 0;

      return _react2.default.createElement(
        'tbody',
        null,
        data.map(function (row, i) {
          return _this4.buildTableRow(row, i + bodyIAdd);
        })
      );
    }
  }, {
    key: 'buildTableRow',
    value: function buildTableRow(row, i) {
      var _this5 = this;

      var isHeaderCell = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
      ...
      return _react2.default.createElement(
        ...
        row.map(function (cell, j) {
          var props = {
            ...
            onMouseDown: cell.disableEvents ? nullFtn : _this5.onMouseDown,
            onDoubleClick: cell.disableEvents ? nullFtn : _this5.onDoubleClick,
            onMouseOver: cell.disableEvents ? nullFtn : _this5.onMouseOver,
            onContextMenu: cell.disableEvents ? nullFtn : _this5.onContextMenu,
    ...
    value: function render() {
      ...
      var isEditing = function isEditing(i, j) {
        return _this6.state.editing.i === i && _this6.state.editing.j === j;
      };
      var isReverting = function isReverting(i, j) {
        return _this6.state.reverting.i === i && _this6.state.reverting.j === j;
      };
      var shouldClear = function shouldClear(i, j) {
        return _this6.state.clear.i === i && _this6.state.clear.j === j;
      };
      ...
      return _react2.default.createElement(
        ...
        this.buildTableBody(bodyData, fixedHeader)
      );
    }
  }]);
