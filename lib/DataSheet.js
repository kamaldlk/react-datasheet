...
var DataSheet = function (_PureComponent) {
  ...
  function DataSheet(props) {
    ...
    _this.defaultState = {
      ...
      cellWidths: _this.sizes.cellWidths
    };
  ...
  _createClass(DataSheet, [{
    ...
    value: function updateCellWidths(headerData, bodyData) {
      ...
      var hasHeader = headerData && headerData.length > 0;
      var hadHeader = cellWidths.header.length > 0;
      var hasBody = bodyData.length > 0;
      var hadBody = cellWidths.body.length > 0;
      var upHeaderResult = update(hasHeader, hadHeader, cellWidths.header, headerData);
    ...
    value: function buildTableHeader(data) {
      ...
      return data && data.length ? _react2.default.createElement(
        ...
        data.map(function (row, i) {
          return _this5.buildHeaderRow(row, i, i === data.length - 1);
        })
      ) : null;
    }
  }, {
    ...
    value: function buildTableBody(data) {
      ...
      return _react2.default.createElement(
        ...
        { ref: function ref(_ref2) {
            return _this6.tbodyDom = _ref2;
          } },
        data.map(function (row, i) {
          return _this6.buildBodyRow(row, i, i === 0);
        })
      );
    }
  }, {
      ...
      return _react2.default.createElement(
        ...
        row.map(function (cell, j) {
          var props = {
            ...
            readOnly: true,
            width: _this7.parseStyleSize(header[i][j]),
      ...
      return _react2.default.createElement(
        ...
        row.map(function (cell, j) {
          var props = {
            ...
            colSpan: cell.colSpan,
            width: _this8.parseStyleSize(body[i][j]),
            overflow: cell.overflow,
    ...
    value: function render() {
      ...
      var fullCN = ['data-grid', className, overflow, headerData && headerData.length && 'has-header'].filter(function (c) {
        return c;
      }).join(' ');
